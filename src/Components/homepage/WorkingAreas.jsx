    ...
    <div className="relative w-full h-32  ">
      {tabs.map((tab, idx) => (
        <motion.div
          ...
          className={cn("w-2/3 md:w-1/2 font-gordita-regular text-white md:h-full md:py-40 md:px-10 px-5 py-5 absolute top-1/2 md:left-1/4  transform -translate-x-1/2 -translate-y-1/2 bg-[#F78D4C] flex items-center justify-center md:overflow-none  md:ml-0 ml-1", className)}
