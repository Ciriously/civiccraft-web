...
const ContactForm = () => {
    ...
    return (
        <form className="bg-white font-gordita-medium rounded-t-lg px-8 pt-40 pb-8 mb-4">
            ...
            <div className="mb-8">
                <input
                    className="shadow-none appearance mb-4 border-b border-gray-300 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500 text-lg"
                    id="fullName"
                    type="text"
            ...
            <div className="mb-8">
                <input
                    className="shadow-none appearance-none mb-4 border-b border-gray-300 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500 text-lg"
                    id="phoneNumber"
                    type="tel"
            ...
            <div className="mb-8">
                <input
                    className="shadow-none appearance-none mb-2 border-b border-gray-300 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500 text-lg"
                    id="howHeard"
                    type="text"
